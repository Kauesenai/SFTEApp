...
public class VansActivity extends AppCompatActivity {
    ...
    private static final String JSON_URL = "https://sftetransporte.com.br/Android/lista_van.php";


    ListView listView;


    List<VansConst> heroList;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray heroArray = obj.getJSONArray("vans");
                            ...
                            for (int i = 0; i < heroArray.length(); i++) {
                                ...
                                VansConst hero = new VansConst(heroObject.getString("id_van"),heroObject.getString("modelo"), heroObject.getString("placa"));
                            ...
                            ListViewVans adapter = new ListViewVans(heroList, getApplicationContext());
    ...
    public void CadastrarVan(View v){
        Intent van = new Intent(VansActivity.this,CadastrarVan.class);
        startActivity(van);
    }
}
